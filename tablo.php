...
$sorgu=$vt->prepare('SELECT *FROM bilgiler');
$sorgu->execute();
...
<html lang="en">
  ...
  <body style="background-image: linear-gradient(to right, black , white);">
    <h1 style="text-align:center;margin-top:1%;color:white">Talep Bilgi  Listesi</h1>
    <table class="table table-sm table-dark mx-auto" style="width: 50%; margin-top:3%;">
        <thead>
          <tr>
            <th scope="col">#</th>
